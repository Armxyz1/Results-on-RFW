...
statedict = torch.load("models/adaface_ir101_webface12m.ckpt")['state_dict']
model_statedict = {key[6:]: value for key, value in statedict.items() if key.startswith('model')}
    ...
    for i in tqdm(range(6000)):
            ...
            try:
                ...
                with torch.no_grad():
                    ...
                    f1 = model(i1)[0]
                    f2 = torch.transpose(model(i2)[0],0,1)
